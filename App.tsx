...
import { BrainDumpItem, Note, SavedTask, MomentumMapData, EnergyTag, ScheduleEvent, SmartReminder, ContextTag, ReminderStatus, DNDWindow, TimeLearningSettings, CompletionRecord, ThemeSettings, ThemeName, CustomThemeProperties, Confirmation, UndoAction } from './types';
...
const useTheme = (activeMap: MomentumMapData | null, scheduleEvents: ScheduleEvent[], dndWindows: DNDWindow[]) => {
    const [themeSettings, setThemeSettings] = useState<ThemeSettings>(() => {
        ...
        try {
            ...
            // Deep merge to ensure all properties are present
            return {
                ...defaultSettings,
                ...storedSettings,
